...
def main():
    ...
    parser.add_argument("--pet_per_gpu_unlabeled_batch_size", default=8, type=int,
    ...
    parser.add_argument("--sc_per_gpu_train_batch_size", default=8, type=int,
    ...
    parser.add_argument("--sc_per_gpu_unlabeled_batch_size", default=8, type=int,
    ...
    eval_set = TEST_SET #DEV_SET # if args.eval_set == 'test' else DEV_SET
